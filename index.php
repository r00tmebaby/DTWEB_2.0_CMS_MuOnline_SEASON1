<?php
	...
	auto_ban();
    clean_vip();
	//lipsva funckiqta Losho, dali q ima v drug paket, kak se kazva che imam edna svalena
	//versiq da vidq dali q ima tam? ako trqbva da e v mod/user, q nqma v tva koeto imam 
