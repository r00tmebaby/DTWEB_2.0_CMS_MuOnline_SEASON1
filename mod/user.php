...
$check_mark   = mssql_num_rows(mssql_query("Select * from [DTweb_Market] where [Seller] = '{$char_info['AccountID']}' and [is_sold] ='0'"));
...
<tr>
<td>
<table style="background:none;float:left;margin-top:60px" >      
          <tbody>
		  <tr>
		    <td> <img width="200px;" height= "380px"src="imgs/classes/'.char_pic($char_info['Class']).'"/></td>
		   </tr>
		  
</table>
<table style="background:none;float:right;position:absolute;margin-left:240px;width:300px;">		  
		  <tr>
            <td align="right" class="alt9"><span class="normal_text">Character:</span></td>
            <td  class="normal_text_white"><div align="left" class="normal_text_white">
                 '.$char.'         </div></td>
...
<div style="text-align:center;padding-bottom:20px;margin-top:120px"> '.$price_is.'</div>	<center>	
<table width="550px" style="background:none;" border="0"  cellpadding="0" cellspacing="2">
                                   <tr>
...
<td> To who you want to send a gift</td>
		...
		</form>'.$end.'</div></centeR> </td></tr></table>';
