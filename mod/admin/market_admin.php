...
switch($settings['credits_multi']){case 1: $settings['credits_multi'] = phrase_none; default: $settings['credits_multi'] = $settings['credits_multi'];}
  ...
  echo '  
   ...
   <tr>
	 ...
	 <td>
	  Zen   &nbsp;<input type="text"  style="width:50px;" maxlength="3" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="zen"  value="'.$settings['zen'].'"/>
	  ...
	  Stone &nbsp;&nbsp;<input type="text"  style="width:50px;" maxlength="3" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="stone"  value="'.$settings['stone'].'"/></br>
	...
	<tr><td class="title" colspan="3">'.phrase_market_fee.'</td></tr>
	 <tr >
	   ...
	   <td><input type="text" min="1" maxlength="4"  name="zen_multi"  value="'.$settings['zen_multi'].'"/> </td>
	 </tr>
	 <tr>
	  ...
	  <td><input type="text" min="1"  value="'.$settings['credits_multi'].'" maxlength="4" name="cr_multi"  /> </td>
	 </tr>
      <tr>
