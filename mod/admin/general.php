...
elseif(isset($_GET['buyjewels'])){
  ...
  if(isset($_POST['submit'])){
     if($_POST['topc_row']  == 0   || $_POST['topg_row'] == 0  || $_POST['topk_row'] == 0){
	   ...
	   mssql_query("Update [DTweb_settings] set
		...
		echo "
			...
			<input class='button' type='submit' value='".phrase_update."' name='submit'/>
				...
				<tr class='title'><td style='text-align:center' colspan='2'>".phrase_server_settings."</td></tr>
                    ...
                    <tr><td title='<div class=admin-title><span> ".phrase_server_host.": </span> ".phrase_server_hosts."'>".phrase_server_host."</td><td><input type='text' class='fields' value='".base64_decode($check_all['server_host'])."' name='host'/></td></tr>
