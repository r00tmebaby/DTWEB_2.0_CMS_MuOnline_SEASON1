...
<script type="text/javascript" src="js/easyTooltip1.js"></script>
...
market_sell($decrypt,$zen,$stone,$rena,$credit,$soul,$chaos,$creation,$bless,$life,$_POST['gogo']);
    ...
    $item_opt = season();
    $user_items = all_items($_SESSION['dt_username']);
...
<a  title=\"<br>".$item['overlib']."\"  href=\"javascript:void(0)\" onclick=\"fireMyPopup{$i}()\" style='width:" . (32 * $InsPosX) . "px;height:" . (32 * $InsPosY - $InsPosY - 1) . "px;'><img style='width:" . (32 * $InsPosX) . "px;height:" . (32 * $InsPosY - $InsPosY - 1) . "px;' src='" . $item['thumb'] . "' class='m' /></td>";
	    } 
		else {
