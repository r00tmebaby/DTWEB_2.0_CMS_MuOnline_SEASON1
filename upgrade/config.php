...
$options['sql_host']       = 'WIN-Q4H841DUAQB';                    // Sql server host: 127.0.0.1,localhost,Your Computer Name, Instance
$options['sql_user']       = 'sa';                    // Sql server user: sa
$options['sql_pass']       = '12345';                    // Sql server password
$options['sql_dbs']        = 'MuOnline';     // Mu online database: default = MuOnline
...
$option['admin_acc']       = "test";              // Administrator User
